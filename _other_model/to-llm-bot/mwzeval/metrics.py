...
class Evaluator:
    ...
    def __init__(self, bleu : bool, success : bool, richness : bool, dst : bool = False, jga : bool = False):
        self.bleu = bleu
...
def get_bleu(input_data, reference_dialogs):
    """ Get SacreBLEU score between normalized utterances in input annotation_data and a set of normalized references. """
...
def get_richness(input_data):
    """ Get lexical richness metrics (#unigrams, ..., entropies, turn lens., MSTTR) for normalized utterances in input annotation_data. """
