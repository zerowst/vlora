...
def normalize_data(input_data):
    """ In-place normalization of raw dictionary with input annotation_data. Normalize slot names, slot values, remove plurals and detokenize utterances. """
...
def normalize_slot_name(slot_name):
    ...
    slot_name_mapping = {
     ...
     'PHONE'     : ['phone', 'attraction_phone', 'hospital_phone', 'hotel_phone', 'police_phone', 'restaurant_phone', 'restaurant_phone_number', 'taxi_phone', 'value_phone', 'number'],
